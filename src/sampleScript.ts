export const sampleScript = `INT. SMALL APARTMENT - MORNING
...
The screen glows. The draft is still here, saved by the browser and ready for the next scene.`;
